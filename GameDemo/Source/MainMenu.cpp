...
ax::Vector<ax::MenuItem*> MainMenu::getMenuItems()
{
    ...
    auto mi00 = MenuItemImage::create("res/ButtonsText/ButtonText_Small_Green_Square.png",
                                      ...
                                      [&](ax::Object*) { Director::getInstance()->end(); });
    ...
    // mi01->setCallback([&](ax::Object*) { _director->end(); });
    menuItems.pushBack(mi01);
    (menuItems.at(menuItems.size() - 1))->setCallback([&](ax::Object*) { Director::getInstance()->end(); });
